...
<div class="flex-center min-vh-100">
    <form method="post" action="{{ route('updateGalleryImages') }}" enctype="multipart/form-data" class="px-4 py-3" style="min-width: 350px">
        @csrf
        <input type="hidden" name="galleryID" value="{{ $gallery->id }}">

        <div class="mb-2">
            <label for="formFile" class="form-label">Item Image (Only png, jpg, jpeg) Max Size: 10MB</label>
           <span class="input-group-text alert-warning"> <i class="fas fa-camera">&nbsp;&nbsp;&nbsp;</i> <input name="galleryImages" class="form-control" type="file" id="formFile" required></span>
        </div>
